...
namespace AlgorithmPractice
{
    ...
    new int[] {1, 2, 3, 2, 3, 4, 5, 6}                     // רצף עם סירוגין בין ירידה לעלייה
            ...
            {
                var arr = testCases[i];
                int recResult = LongestIncreasingSubqunce.LongIncreasingSubRec(arr, arr.Length - 1, int.MaxValue);
                int dpResult = LongestIncreasingSubqunce.LongIncreasingSub(arr);
